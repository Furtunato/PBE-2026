<style>
    ...
    * {
    ...
    /* Botão Novo Pedido com animação */
    .btn-primary {
        background: linear-gradient(135deg, #ed64a6 0%, #d53f8c 100%);
        color: white;
        padding: 12px 24px;
...
<x-app-layout>
                            ...
                            <div>
                                ...
                                <div class="pedido-info">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span class="valor">R$ {{ number_format($pedido->valor_total, 2, ',', '.') }}</span>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- MODAL -->
    <div id="modalExcluirPedido" class="modal">
    ...
    <!-- SCRIPT -->
    <script>
        function abrirModalPedido(element) {
            let id = element.getAttribute('data-id');
            let nome = element.getAttribute('data-nome');

            document.getElementById('modalExcluirPedido').classList.add('show');
            document.getElementById('nomePedido').innerText = nome;
            document.getElementById('formExcluirPedido').action = '/pedidos/' + id;
        }

        function fecharModalPedido() {
            document.getElementById('modalExcluirPedido').classList.remove('show');
        }

        // Fechar modal ao clicar fora
        window.onclick = function(event) {
            let modal = document.getElementById('modalExcluirPedido');
