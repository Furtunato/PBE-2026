...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 header-bg">Editar Cliente</h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="main-container">
            <div class="content-card">
                ...
                <h3 class="form-title">✏️ Editar Cliente</h3>
                    ...
                    <div class="form-grid">
                        ...
                        <div>
                            ...
                            <input type="text" name="endereco" value="{{ $cliente->endereco }}" 
                                   class="form-input" placeholder="Rua, número, bairro">
                        </div>
                    </div>
