    ...
    <div class="py-12">
        <div class="main-container">
            <div class="content-card">
                ...
                <h3 class="form-title">✏️ Editar Produto</h3>

                <!-- Formulário apontando para a rota de atualizar -->
                <form action="{{ route('produtos.update', $produto->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nome" value="{{ old('nome', $produto->nome) }}" 
                               class="form-input" placeholder="Digite o nome do produto" required>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            @error('preco') <span class="error-message">{{ $message }}</span> @enderror
                        </div>

                        <div class="form-group">
                            <label class="form-label">Quantidade em Estoque</label>
                            <input type="number" name="quantidade" value="{{ old('quantidade', $produto->quantidade) }}" 
